...
<body id="kt_body"
  ...
  <div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 {{ $pageclass }} d-flex flex-row-fluid" id="kt_login">
      <div class="d-flex bgi-size-cover bgi-no-repeat flex-row-fluid"
        ...
        <div class="overflow-hidden text-center text-white login-form p-7 position-relative">
          ...
          <div class="d-flex flex-center mb-15">
            <a href="#">
              <img src="{{ asset('media/logos/logo-EULER.jpg') }}" class="max-h-200px" alt="" />
            </a>
          </div>
          <!--end::Login Header-->
          @yield('content')
        ...
        <div class="d-flex bgi-size-cover bgi-no-repeat flex-row-fluid"
        style="background-image: url({{ asset('media/bg/bg-EULER2.jpg') }});">
      </div>
    </div>
    <!--end::Login-->
