                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="m-0">Registrar Alumno</h2>
                            </div>
                            <div class="card-body">
                                @if (session('status'))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-5">
                                                ...
                                                <input type="text" class="form-control" id="txtNombre" name="nombres"
                                                    required placeholder="Nombre" value="{{ old('nombres') }}">
                                                @error('nombres')
                                            ...
                                            <div class="col-xs-12 col-md-5">
                                                ...
                                                <input type="text" class="form-control" id="txtApellido" name="apellidos"
                                                    required placeholder="apellidos" value="{{ old('apellidos') }}">
                                                    @error('apellidos')
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-4">
                                                ...
                                                <select class="form-control" name="area" id="cboArea">
                                                    <option {{ old('area') == 'CIENCIAS' ? 'selected' : '' }} value="CIENCIAS">Ciencias</option>
                                                    <option {{ old('area') == 'LETRAS' ? 'selected' : '' }} value="LETRAS">Letras</option>
                                                    <option {{ old('area') == 'MEDICINA' ? 'selected' : '' }} value="MEDICINA">Medicina</option>
                                                </select>
                                                @error('area')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                ...
                                                <select class="form-control" name="modalidad" id="cboModalidad">
                                                    <option {{ old('modalidad') == 'ORDINARIO' ? 'selected' : '' }} value="ORDINARIO">Ordinario</option>
                                                    <option {{ old('modalidad') == 'CEPUNT' ? 'selected' : '' }} value="CEPUNT">CEPUNT</option>
                                                    <option {{ old('modalidad') == 'EXCELENCIA' ? 'selected' : '' }} value="EXCELENCIA">Excelencia</option>
                                                </select>
                                                @error('modalidad')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                ...
                                                <select class="form-control" name="turno" id="cboTurno">
                                                    <option {{ old('turno') == 'AMBOS' ? 'selected' : '' }} value="AMBOS">Mañana - Tarde</option>
                                                    <option {{ old('turno') == 'MAÑANA' ? 'selected' : '' }} value="MAÑANA">Mañana</option>
                                                    <option {{ old('turno') == 'TARDE' ? 'selected' : '' }} value="TARDE">Tarde</option>
                                                </select>
                                                @error('turno')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-xs-16 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="txtNombreApoderado"
                                                    name="nombresApoderado" required placeholder="Nombre" value="{{ old('nombresApoderado') }}">
                                            ...
                                            <div class="col-xs-16 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="txtApellidoApoderado"
                                                    name="apellidosApoderado" required placeholder="apellidos" value="{{ old('apellidosApoderado') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-16 col-md-8">
                                                ...
                                                <input type="email" class="form-control" id="txtEmailApoderado"
                                                    name="emailApoderado" required placeholder="example@example.com" value="{{ old('emailApoderado') }}">
                                            ...
                                            <div class="col-xs-16 col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="txtCelApoderado"
                                                    name="celularApoderado" required placeholder="999888555" value="{{ old('celularApoderado') }}">
