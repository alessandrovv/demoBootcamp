                    ...
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('grupo.update', $grupo->id)}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-16 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="txtNombre" name="descripcion"
                                                    required placeholder="Nombre" value="{{ old('descripcion',$grupo->descripcion) }}">
                                                @error('descripcion')
