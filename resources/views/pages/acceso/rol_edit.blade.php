                        ...
                        <div class="col-md-10">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ route('rol.update', $rol->id)}}" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="_method" value="PUT">
                                      @csrf
                                      <div class="form-group">
                                        <label for="" >Nombre</label>
                                        <input type="text" class="form-control" id="name" name="name" required value="{{ $rol->name }}" onkeypress="return validarSoloLetras(event)">
                                      </div>
                                      
                                      <div class="form-group">
                                        <label for="">Descripcion</label>
                                        <textarea type="text" class="form-control" id="descripcion" name="descripcion" required>{{ $rol->descripcion}}</textarea>
                                      </div>                                     
                                      <br>
