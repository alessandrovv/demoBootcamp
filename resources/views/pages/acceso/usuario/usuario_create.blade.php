                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('usuario.store')}}" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" required placeholder="Estela Villar">
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" required placeholder="estela@example.com">
                                      </div>
                                      ...
                                      <a class="btn btn-danger" href="{{route('usuario.index')}}">Volver</a>
                                    </form>
                                </div>
                            </div>
                        </div>
