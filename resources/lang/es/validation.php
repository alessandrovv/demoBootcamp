...
return [
    ...
    */
    ...
    | convención "nombre-atributo.regla" para nombrar las líneas. Esto nos permite
    | especificar rápidamente un mensaje de idioma personalizado específico para una regla de atributo determinada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para reemplazar nuestros marcadores de posición de atributos
